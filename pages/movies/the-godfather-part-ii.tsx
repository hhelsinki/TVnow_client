...
const TheGodfatherPartII = () => {
    ...
    return (
        <>
            <Head>
                <title>TVnow: The Godfather Part II</title>
                <meta name="description" content="Watch The Godfather Part II Movie" />
            </Head>
            <HeaderSEO />
...
export default TheGodfatherPartII;